...
orchestrator.addListener('dataReady', function (e) {
    ...
    var f2 = 0;
    if (max2 - min2 < 0.4) f2 = 0.5 * (max2 - min2);
    ...
    function update() {
        ...
        y_axis_box2 = svg_box_b2.select(".y_axis").transition().duration(150).style("display", null).call(yAxis2.ticks(6));
