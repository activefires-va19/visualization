...
orchestrator.addListener('dataReady', function (e) {
    ...
    function update() {
        ...
        y_axis_box3 = svg_box_b3.select(".y_axis").transition().duration(150).style("display", null).call(yAxis3.ticks(6));
        ...
        svg_box_b3.select("#label_frp").style("fill", colorManager.getTextColor());
